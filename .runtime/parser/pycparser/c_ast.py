...
class KernelDef(Node):
    __slots__ = ('decl', 'config', 'param_decls', 'body', 'coord', '__weakref__')
    def __init__(self, decl, config, param_decls, body, coord=None):
        self.decl = decl
        self.config = config
    ...
    def children(self):
        ...
        if self.config is not None: nodelist.append(("config", self.config))
